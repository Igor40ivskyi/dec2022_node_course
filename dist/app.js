...
app.get("/users/:userId", async (req, res) => {
    try {
        const foundUserById = await User_model_1.User.findById(req.params.userId);
...
app.put("/users/:userId", async (req, res) => {
    try {
        ...
        const updatedUser = await User_model_1.User.findOneAndUpdate({ _id: userId }, { ...req.body }, {
...
app.delete("/users/:userId", async (req, res) => {
    try {
        const { userId } = req.params;
        const deletedUser = await User_model_1.User.findOneAndDelete({ _id: userId });
